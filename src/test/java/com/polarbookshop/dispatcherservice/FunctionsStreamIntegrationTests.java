...
class FunctionsStreamIntegrationTests {
    ...
    void whenOrderAcceptedThenDispatched() throws IOException {
        ...
        OrderDispatchedMessage actualMessage = objectMapper.readValue(output.receive().getPayload(), OrderDispatchedMessage.class);
        assertThat(actualMessage).isEqualTo(expectedOutputMessage.getPayload());
    }
